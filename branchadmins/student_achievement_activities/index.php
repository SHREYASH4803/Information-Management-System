            ...
            <div id="tabledataid" class="card">
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $table_query = "SELECT * FROM achievement WHERE  Branch = '$branch' AND STATUS = 'approved' ORDER BY id ASC";
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `achievement` WHERE STATUS = 'approved' AND Branch = '$branch' AND   (Branch LIKE '%$str%' OR division LIKE '%$str%' OR  Roll_no LIKE '%$str%' OR Name_Of_The_Student LIKE '%$str%' OR Year_Of_Study LIKE '%$str%'  OR Extracurricular_Or_Cocurricular LIKE '%$str%' OR Name_Of_Activity LIKE '$str' OR Type_Of_The_Activity LIKE '%$str%'
