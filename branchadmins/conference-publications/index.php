...
?>
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">					
				<button type="submit" onclick="exportTableToCSVuser('USerData_ConferencePublications.csv')" class="btn btn-success">Export to excel</button>
			</form> &nbsp; &nbsp; 
...
<div id="tabledataid" class="card">
    <div class="card-body">
        ...
        if (isset($_POST['reject'])) {
            $id = $_POST['id'];
            $select = "UPDATE conferencepublication SET STATUS ='Sent Back' WHERE id='$id'";
            $result = mysqli_query($connection, $select);
            echo "Data Rejected";
            header("Location: index.php");
        }
...
foreach ($branches as $branchOption) {
    ...
    echo '<option value="' . $branchOption . '" ' . $selected . '>' . $branchOption . '</option>';
        ...
        ?>
                        ...
                        <div class="form-group">
    <label>INDEXING</label>
    <select name="Indexing" class="form-control" id="indexing-select" required>
