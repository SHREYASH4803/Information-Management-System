...
<body>
 ...
 <!-- buttons and search buttoncard -->
            ...
            <?php 
if ($_SESSION["role"] == true) {
    echo '<div style="position: absolute; top: 100px; right: 70px; font-weight: bold; color: #007bff;">Welcome ' . $_SESSION["role"] . '<br><span style="color: #008000;">You logged in EBSB-Club</span></div>';
} else {
    header("Location: index.php"); 
}
?>
            ...
            <div id="tabledataid" class="card">
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $table_query = "SELECT * FROM workshops WHERE Source ='ebsb' ORDER BY id ASC";
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `workshops` WHERE Source ='ebsb' AND (branch LIKE '%$str%' OR workshop_seminar LIKE '%$str%' OR year LIKE '%$str%'  OR coordinator LIKE '%$str%' OR title LIKE '%$str%' OR category LIKE '$str' OR others LIKE '%$str%' OR no_of_participants LIKE '%$str%' OR start_date LIKE '%$str%' OR end_date LIKE '%$str%' OR STATUS LIKE '$str') ";
