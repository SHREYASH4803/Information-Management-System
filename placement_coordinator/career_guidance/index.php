                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="career_year" class="form-control" required>
                                ...
                                <option name="career_year" value="2022-23">2022-23</option>
                                <option name="career_year" value="2023-24">2023-24</option>
                                <option name="career_year" value="2024-25">2024-25</option>
                            </select>
                        </div>
                ...
                while($row = mysqli_fetch_assoc($result)){   
                    ...
                    <td> <?php echo $row['id']; ?> </td>
                        ...
                        <td>
                            <!--<a href="read.php?viewid=<?php echo htmlentities ($developer['id']);?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>-->
                            <!-- <a class="edit btn-success editbtn" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a> -->
                            <a href="../../placementcell/career_guide/uploadsfdporganized/<?php echo $developer['pdffile']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
