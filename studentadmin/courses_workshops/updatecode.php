...
$queryresult = mysqli_num_rows($query); 
    ...
    {   
        ...
        move_uploaded_file($file_tmp1,"../../student/courses_workshops/certificates/$pdffile1");
		// move_uploaded_file($file_tmp2,"../../professors/book-chapters/uploadsfrontit/$pdffile2");
        
 
            $query = "UPDATE courses SET Name_Of_The_Student = '$Name_Of_The_Student', Roll_no = '$Roll_no', 
        Branch = '$Branch',division = '$division',, Year_Of_Study = '$Year_Of_Study', Current_Year = '$Current_Year', 
        Type_Of_Course = '$Type_Of_Course', Title_Of_Course = '$Title_Of_Course', Organizing_Body = '$Organizing_Body', 
        Others = '$Others', Duration = '$Duration', Dates_From = '$Dates_From', Dates_To = '$Dates_To' WHERE id='$id'  ";
