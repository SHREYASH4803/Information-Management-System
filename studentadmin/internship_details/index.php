...
<div id="tabledataid" class="card">
    <div class="card-body">
        ...
        <table id="datatableid" class="table table-bordered table-dark mt-2">
            ...
            $table_query = "SELECT * FROM internship_details WHERE Branch = '$branch' AND Year_Of_Study = '$Year_Of_Study' AND division = '$division' ORDER BY id ASC";
                ...
                while ($developer = mysqli_fetch_assoc($query_run)) {
                    ...
                    <tbody> <!-- change -->
                        ...
                        <td> <td> <?php echo $developer['id']; ?> </td>
                            ...
                            <td>
                                <!-- <a href="../../student/internship_details/certificates1/<?php echo $developer['pdffile1']; ?>" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a> -->
                                <a href="../../student/internship_details/certificates2/<?php echo $developer['pdffile2']; ?>" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                                <a href="../../student/internship_details/certificates3/<?php echo $developer['pdffile3']; ?>" class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
        ...
        if (isset($_POST['reject'])) {
            $id = $_POST['id'];
            $select = "UPDATE internship_details SET STATUS ='Sent Back' WHERE id='$id'";
            $result = mysqli_query($connection, $select);
            echo "Data Rejected";
            header("Location: index.php");
        }
        ...
        ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="Year_Of_Study" class="form-control" required>
                                <option value="Year_Of_Study">--Select Year--</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="Number_of_Days_of_Internship" name="Number_of_Days_of_Internship" class="form-control" placeholder="Number_of_Days_of_Internship" required>
                        </div>     
                        <div class="form-group">
                            <label> Name of the Organization* </label>
                            <input type="text" id="Name_of_Organization" name="Name_of_Organization" class="form-control" placeholder="Enter name of Organizing Body" required>
                        </div>
                        <div class="form-group">
                            <label> Address of the Organization* </label>
                            <input type="text" id="Organizing_Addr" name="Organizing_Addr" class="form-control" placeholder="Enter address of Organizing Body" required>
                        </div>            
                    </div>
                    <div class="modal-footer">
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `internship_details` WHERE Branch = '$branch'  AND division = '$division'  AND (Branch LIKE '%$str%' OR Roll_no LIKE '%$str%' OR Name_Of_The_Student LIKE '%$str%' OR Year_Of_Study LIKE '%$str%' OR academic_year LIKE '%$str%' OR Name_Of_Organization LIKE '$str' OR Number_of_Days_of_Internship LIKE '%$str%' OR Organizing_Addr LIKE '%$str%' OR Dates_From LIKE '%$str%' OR Dates_To LIKE '%$str%' OR STATUS LIKE '$str' ) ";
                ...
                ?>               
                    <td> <?php echo $row['id']; ?> </td>
                        ...
                        <td>
                            ...
                            <!-- <a href="../../student/internship_details/certificates1/<?php echo $row['pdffile1']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a> -->
                            <a href="../../student/internship_details/certificates2/<?php echo $row['pdffile2']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a href="../../student/internship_details/certificates3/<?php echo $row['pdffile3']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
     ...
     <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#Dates_To').val(data[8]);
                $('#Number_of_Days_of_Internship').val(data[9]);
                $('#Name_of_Organization').val(data[10]);
                $('#Organizing_Addr').val(data[11]);
