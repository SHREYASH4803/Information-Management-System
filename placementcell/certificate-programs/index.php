                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="Year_of_offering" class="form-control" required>
                                ...
                                <option name="Year_of_offering" value="2017-2018">2017-2018</option>
                                <option name="Year_of_offering" value="2018-2019">2018-2019</option>
                                <option name="Year_of_offering" value="2019-2020">2019-2020</option>
                                <option name="Year_of_offering" value="2020-2021">2020-2021</option>
                                <option name="Year_of_offering" value="2021-2022">2021-2022</option>
                                <option name="Year_of_offering" value="2022-2023">2022-2023</option>
                                <option name="Year_of_offering" value="2023-2024">2023-2024</option>
                                <option name="Year_of_offering" value="2024-2025">2024-2025</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label>  No of Times Offered</label>
                        ...
                        <div class="form-group">
                            <label>  No of Students Completing</label>
            ...
            <div id="tabledataid" class="card">
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $table_query = "SELECT * FROM certificates WHERE user_id=$id ORDER BY id ASC";
