...
<head>
    ...
    <title> Workshop/Seminar Organized </title>
...
<body>
            ...
            <div class="modal-content">
                ...
                <form action="insertcode.php" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label> If others, please mention Theme/Category</label>
 ...
 <!-- buttons and search buttoncard -->
            ...
            <div class="card-body mt-5">
                <h2> WORKSHOPS/SEMINARS ORGANIZED BY DEPARTMENT</h2>
            </div>
            <div class="card">
    ...
    echo '<option value="' . $branchOption . '" ' . $selected . '>' . $branchOption . '</option>';
        ...
        ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control" placeholder="title of workshop/seminar" required>
                        </div>
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `workshops` WHERE user_id=$id AND (branch LIKE '%$str%' OR workshop_seminar LIKE '%$str%' OR year LIKE '%$str%'  OR coordinator LIKE '%$str%' OR title LIKE '%$str%' OR category LIKE '$str' OR others LIKE '%$str%' OR no_of_participants LIKE '%$str%' OR start_date LIKE '%$str%' OR end_date LIKE '%$str%' OR STATUS LIKE '$str') ";
        ...
        $queryresult = mysqli_num_rows($result); ?>
                    ...
                    <div class="card">
                        <div class="card-body btn-group">
                        <div> Results- </div> &nbsp; &nbsp;
                        <button class="btn btn-success" onclick="exportTableToCSV('Search_data_Workshop_Seminar.csv')"> Export Data </button>
                        </div>
                    </div>
