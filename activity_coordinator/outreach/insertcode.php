...
if (isset($_POST['insertdata'])) {
    $Name_of_Activity = $_POST['Name_of_Activity'];
        ...
        $Other_Scheme = $_POST['Other_Scheme'];
    ...
    (`Name_of_Activity`, `Organizing_Unit`, `Name_of_Coordinators`, `Name_Of_Scheme`, `Other_Scheme`,`Dates_Conducted`, `Year_of_Activity`, 
    `No_of_Student_Volunteer_for_Activity`, `No_of_People_benefitted_by_Activity`, `pdffile1`, `user_id`,`STATUS`) 
    VALUES (' $Name_of_Activity', ' $Organizing_Unit', '$Name_of_Coordinators', '$Name_Of_Scheme', '$Other_Scheme', '$Dates_Conducted',
