...
<head>
    ...
    <title> Outreach Programs Organized </title>
...
<body>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="Name_Of_Scheme" class="form-control" required>
                                ...
                                <!-- <option name="Name_Of_Scheme" value="2021-23">2022-23</option> -->
                            </select>
                        </div>

                        <div class="form-group">
                            <label> If any Other Scheme, then please specify</label>
                            <input type="text" name="Other_Scheme" class="form-control" placeholder="Enter Title" >
                        </div>
                        ...
                        <div class="form-group">
                            <label>Number of People Penefitted by the Activity* </label>
 ...
 <!-- buttons and search buttoncard -->
            ...
            <div class="card-body mt-5">
                <h2> OUTREACH PROGRAMMES CONDUCTED BY INSTITUTE</h2>
            </div>
            <div class="card">
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">					
				<button type="submit" onclick="exportTableToCSVuser('USerData_OutreachActivity.csv')" class="btn btn-success">Export to excel</button>
			</form> &nbsp; &nbsp; 
            ...
            <div id="tabledataid" class="card">
                ...
                ?>
                                ...
                                <td> <?php echo $developer['Other_Scheme']; ?> </td>
    ...
    if (isset($_POST["submit"])) {
        ...
        $queryresult = mysqli_num_rows($result); ?>
                    ...
                    <div class="card">
                        <div class="card-body btn-group">
                        <div> Results- </div> &nbsp; &nbsp;
                        <button class="btn btn-success" onclick="exportTableToCSV('Search_data_OutreachActivity.csv')"> Export Data </button>
                        </div>
                    </div>
                ...
                ?>           
                        ...
                        <td> <?php echo $row['Other_Scheme']; ?> </td>
