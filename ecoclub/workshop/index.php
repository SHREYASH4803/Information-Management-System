                ...
                <form action="insertcode.php" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Year (July 1st - June 30th)*</label>
                        ...
                        <div class="form-group">
                            <label> Title of workshop / seminar </label>
                            <input type="text" name="title" class="form-control" placeholder="Enter Title of Workshop/ Seminar" required>
                        </div>

                        <div class="form-group">
                            <label>Category of activity*</label>
                            <select name="category" class="form-control" required>
                                <option value="">--Select Type of activity-</option>
                                <option name="category" value="Research Methodology">Research Methodology</option>
                                <option name="category" value="IPR">Intellectual Property Rights (IPR) </option>
                                ...
                                <option name="category" value="Language and Communication Skills">Language and Communication Skills</option>
                                <option name="category" value="Life skills">Life skills (Yoga, Physical Fitness, Health and Hygiene)</option>
                                <option name="category" value="ICT">ICT</option>
                                <option name="category" value="Computing skills">Computing skills</option>
                                <option name="category" value="Promotion of gender equity">Promotion of gender equity</option>
                                <option name="category" value="Value education">Value education</option>
                                <option name="category" value="Ethics">Ethics</option>
                                <option name="category" value="Environmental Consciousness Activity">Environmental Consciousness Activity</option>
...
?>
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">					
				<button type="submit" onclick="exportTableToCSVuser('USerData_Workshops_Seminar.csv')" class="btn btn-success">Export to excel</button>
			</form> &nbsp; &nbsp; 
            ...
            <div id="tabledataid" class="card">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"> TITLE OF WORKSHOP /SEMINAR </th>
                                <th scope="col"> CATEGORY OF ACTIVITY </th>
                        ...
                        $table_query = "SELECT * FROM workshops WHERE Source ='ecoclub' ORDER BY id ASC";
                ...
                ?>
                                ...
                                <td>
                                <a href="../../activity_coordinator/workshop/uploads/<?php echo $developer['pdffile1']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel"> (Please enter the datas again)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <form action="updatecode.php" method="POST">
                    ...
                    <div class="modal-body">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label> Title </label>
                            <input type="text" id="title" name="title" class="form-control" placeholder="title of workshop/seminar" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label> Others</label>
                            <input type="text" id="others" name="others" class="form-control" placeholder="Enter Category">
                        </div>

                        <div class="form-group">
                            <label> Participants</label>
                            <input type="number" id="no_of_participants" name="no_of_participants"  class="form-control" placeholder="Enter Number of participants" required>
                        </div>
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `workshops` WHERE Source ='ecoclub' AND (branch LIKE '%$str%' OR workshop_seminar LIKE '%$str%' OR year LIKE '%$str%'  OR coordinator LIKE '%$str%' OR title LIKE '%$str%' OR category LIKE '$str' OR others LIKE '%$str%' OR no_of_participants LIKE '%$str%' OR start_date LIKE '%$str%' OR end_date LIKE '%$str%' OR STATUS LIKE '$str') ";
...
<a href="../../activity_coordinator/workshop/uploads/<?php echo $row['pdffile1']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
							<!-- <a href="uploadsfrontit/<?php echo $developer['pdffile2']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a> -->
<!--                             <a class="delete btn-danger deletebtn" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
 -->							
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#category').val(data[5]);
                $('#others').val(data[6]);
                $('#no_of_participants').val(data[7]);
                $('#start_date').val(data[8]);
                $('#end_date').val(data[9]);
