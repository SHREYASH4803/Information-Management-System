...
if (isset($_POST['insertdata'])) {
    ...
    move_uploaded_file($file_tmp1,"../../activity_coordinator/workshop/uploads/$pdffile1");
    ...
    '$title', '$category', '$others', '$no_of_participants', '$start_date', '$end_date','$pdffile1' ,'$id','PENDING','ecoclub')";
