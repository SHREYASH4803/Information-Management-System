...
?>
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">					
				<button type="submit" onclick="exportTableToCSVuser('USerData_Workshop_Seminar.csv')" class="btn btn-success">Export to excel</button>
			</form> &nbsp; &nbsp; 
            ...
            <div id="tabledataid" class="card">
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $table_query = "SELECT * FROM workshops WHERE Source ='nss' ORDER BY id ASC";
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `workshops` WHERE WHERE Source ='nss'  AND (workshop_seminar LIKE '%$str%' OR branch LIKE '%$str%' OR year LIKE '%$str%'  OR coordinator LIKE '%$str%' OR title LIKE '%$str%' OR category LIKE '$str' OR others LIKE '%$str%' OR no_of_participants LIKE '%$str%' OR start_date LIKE '%$str%' OR end_date LIKE '%$str%' OR STATUS LIKE '$str') ";
