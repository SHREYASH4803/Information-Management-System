...
<?php include('../../header.php'); ?>
                ...
                <form action="insertcode.php" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Organizing_Unit" class="form-control" placeholder="Enter Organizing unit" required>
                        </div>

                        <div class="form-group">
                            <label> Name of the Coordinator* </label>
                            <input type="text" name="Name_of_Coordinators" class="form-control" placeholder="Enter Coordinator" required>
                        </div>

                        <div class="form-group">
                            <label>Name of the scheme/department*</label>
                            <select name="Name_Of_Scheme" class="form-control"  placeholder="Name_Of_Scheme" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="Dates_Conducted" class="form-control" placeholder="Enter Dates"  max="<?php echo date('Y-m-d'); ?>"required>
                        </div>

                        <div class="form-group">
                            <label> Year of the activity*</label>
                            <input type="number" name="Year_of_Activity" class="form-control" placeholder="Enter Year" required>
                        </div>

                        <div class="form-group">
                            <label> Number of student volunteers for the activity* </label>
                            <input type="number" name="No_of_Student_Volunteer_for_Activity" class="form-control" placeholder="Enter Number of student" required>
                        </div>

                        <div class="form-group">
                            <label>Number of people benefitted by the activity* </label>
                            <input type="number" name="No_of_People_benefitted_by_Activity" class="form-control" placeholder="Enter Number of people benefitted" required>
                        </div>               
 ...
 <!-- buttons and search buttoncard -->
            ...
            <?php 
if ($_SESSION["role"] == true) {
    echo '<div style="position: absolute; top: 100px; right: 70px; font-weight: bold; color: #007bff;">Welcome ' . $_SESSION["role"] . '<br><span style="color: #008000;">You logged in NSS-Club</span></div>';
} else {
    header("Location: index.php"); 
}
?>
            ...
            <div id="tabledataid" class="card">
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $table_query = "SELECT * FROM outreachprogram WHERE Name_Of_Scheme = 'NSS' ORDER BY id ASC";
            ...
            <div class="modal-content">
                ...
                <form action="updatecode.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label> Organizing unit/agency/collaborating agency* </label>
                            <input type="text" name="Organizing_Unit" id = "Organizing_Unit"  class="form-control" placeholder="Enter Title" required>
                        </div>
