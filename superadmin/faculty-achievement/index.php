...
<head>
    ...
    <title> Faculty Recognization with Awards </title>
...
<body>
 ...
 <!-- buttons and search buttoncard -->
            ...
            <div class="card-body mt-5">
                <h2>Faculty Recognization with Awards</h2>
            </div>
            ...
            <div id="tabledataid" class="card">
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $table_query = "SELECT * FROM facultyachievement WHERE STATUS = 'approved' ORDER BY id ASC";
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `facultyachievement` WHERE STATUS='approved' AND (Academic_Year LIKE '%$str%' OR Name_Of_The_Faculty LIKE '%$str%' OR Nature_of_Achievement LIKE '%$str%' OR Details_of_Achievement	 LIKE '%$str%' OR Branch LIKE '%$str%' OR other LIKE '%$str%' )";        
