            ...
            <div id="tabledataid" class="card">
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $table_query = "SELECT * FROM facultyinteraction  WHERE STATUS = 'APPROVED' ORDER BY id ASC";
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM facultyinteraction WHERE STATUS = 'APPROVED' AND (Academic_Year LIKE '%$str%' OR Name_of_Faculty LIKE '%$str%' OR Nature_of_interaction LIKE '%$str%' OR Details_of_interaction LIKE '%$str%' OR Date_of_interaction LIKE '%$str%' OR Level_of_interaction LIKE '%$str%' OR  Duration LIKE '%$str%'OR STATUS LIKE '$str')";
...
<td>
                            ...
                            <!-- <a class="edit btn-success editbtn" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a> -->
                            <a href="../../professors/faculty-interaction/certificates/<?php echo $row['pdffile1']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#Nature_of_interaction').val(data[2]);
                $('#Branch').val(data[3]);
                $('#Date_of_interaction').val(data[4]);
                $('#Level_of_interaction').val(data[5]);
                $('#Duration').val(data[6]);
                $('#Details_of_interaction').val(data[7]);
                $('#pdffile1').val(data[8]);
