                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        <thead>
                            ...
                            <th scope="col"> Academic Year </th>
                                ...
                                <th scope="col"> Uploaded admitcard idcard </th>
                            </tr>
                        </thead>
...
<div id="srch" class="card-body">
    ...
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `higher_studies` WHERE STATUS='approved' AND ( Branch LIKE '%$str%' OR year LIKE '%$str%' OR roll_no LIKE '%$str%' OR student_name LIKE '%$str%' OR institute_name_joined LIKE '%$str%' OR program_name_admitted LIKE '%$str%' OR STATUS LIKE '%$str%') ";
