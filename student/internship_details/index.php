    ...
    <select name="division" class="form-control" required disabled>
        ...
        ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="Number_of_Days_of_Internship" class="form-control" placeholder="Number_of_Days_of_Internship" required>
                        </div>            
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="pdffile2" id="pdffile2" accept="application/pdf"  required/><br>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="pdffile3" id="pdffile13"  accept="application/pdf" required/><br>
 ...
 <!-- buttons and search buttoncard -->
            ...
            <div id="tabledataid" class="card">
                ...
                ?>
                            ...
                            <!-- <a href="certificates1/<?php echo $developer['pdffile1']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a> -->
                            <a href="certificates2/<?php echo $developer['pdffile2']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a href="certificates3/<?php echo $developer['pdffile3']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
        ...
        $queryresult = mysqli_num_rows($result); ?>
                ...
                ?>  
                        ...
                        <td>
                            ...
                            <!-- <a class="edit btn-success editbtn" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a> -->
                            <a href="certificates1/<?php echo $row['pdffile1']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a href="certificates2/<?php echo $row['pdffile2']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                            <a href="certificates3/<?php echo $row['pdffile3']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
