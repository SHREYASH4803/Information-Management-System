...
$queryresult = mysqli_num_rows($query); 
    ...
    {   
        ...
        Nature_of_interaction = '$Nature_of_interaction',other = '$other', Level_of_interaction = '$Level_of_interaction', 
        Details_of_interaction = '$Details_of_interaction', 
        Date_of_interaction = '$Date_of_interaction',  Duration = '$Duration',STATUS = 'PENDING'
        WHERE id='$id' ";
