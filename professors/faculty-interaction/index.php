                ...
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $queryresult = mysqli_num_rows($query); 
                            ...
                            $table_query = "SELECT * FROM facultyinteraction WHERE user_id=$id";
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM facultyinteraction WHERE user_id=$id AND (Academic_Year LIKE '%$str%' OR Branch LIKE '%$str%' OR Name_of_Faculty LIKE '%$str%' OR Nature_of_interaction LIKE '%$str%' OR Details_of_interaction LIKE '%$str%' OR Date_of_interaction LIKE '%$str%' OR Level_of_interaction LIKE '%$str%' OR  Duration LIKE '%$str%' OR STATUS LIKE '$str')";
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#Nature_of_interaction').val(data[4]);
                $('#other').val(data[5]);
                $('#Details_of_interaction').val(data[6]);
                $('#Date_of_interaction').val(data[7]);
                $('#Level_of_interaction').val(data[8]);
                $('#Duration').val(data[9]);
