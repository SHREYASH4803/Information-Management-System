...
$queryresult = mysqli_num_rows($query); 
    ...
    {   
        ...
        Affiliating_Institute = '$Affiliating_Institute',Name_Of_Publisher = '$Name_Of_Publisher',Details_Of_Paper = '$Details_Of_Paper', Indexing = '$Indexing',other='$other',Paper_Weblink = '$Paper_Weblink' ,STATUS = 'PENDING' WHERE id='$id' ";
