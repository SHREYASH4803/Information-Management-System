                    ...
                    <div class="form-group">
                        ...
                        foreach ($branches as $branchOption) {
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" name="Name_Of_The_Teacher" class="form-control" placeholder="Enter Name" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="Activity_Name" class="form-control" required>
                                ...
                                <option name="Activity_Name" value="Conference"> Conference </option>
                                <option name="Activity_Name" value="Workshop"> Workshop </option>
                                <option name="Activity_Name" value="FDP/STTP"> FDP/STTP </option>
                                <option name="Activity_Name" value="Professional Body Membership">Professional Body Membership</option>
                                <option name="Activity_Name" value="Others">Others</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label> Others </label>
                            <input type="text" name="Other_Activity" class="form-control" placeholder="Enter Title of Activity">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Name_Of_Activity" class="form-control" placeholder="Enter Name of the Activity" required>
                        </div>

                        <div class="form-group">
                            <label> Enter Amount of Support* </label>
                            <input type="number" name="Amount_Of_Support" class="form-control" placeholder="Enter Amount of Support" required>
                        </div>
            ...
            <div id="tabledataid" class="card">
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $table_query = "SELECT * FROM financial_support WHERE user_id=$id";  
                ...
                ?>
                                ...
                                <td>
                                <a href="documents/<?php echo $developer['pdffile1']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
            ...
            <div class="modal-content">
                ...
                <form action="updatecode.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label> Title of the Program* </label>
                            <input type="text" name="Title_Of_Program" id="Title_Of_Program" class="form-control" placeholder="Enter Title" required>
                        </div>

                        <div class="form-group">
                            <label> Select Activity for which Financial Support was provided*  </label>
                            <input type="text" name="Activity_Name"  id="Activity_Name" class="form-control" placeholder="Enter Title of Chapter">
                        </div>

                        <div class="form-group">
                            <label> Others </label>
                            <input type="text" name="Other_Activity" id="Other_Activity" class="form-control" placeholder="Enter Name of Publisher" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label> Enter Name of the Activity* </label>
                            <input type="text" name="Name_Of_Activity" id="Name_Of_Activity" class="form-control" placeholder="Enter Name of Publisher" required>
                        </div>

                        <div class="form-group">
                            <label> Enter Amount of Support* </label>
                            <input type="text" name="Amount_Of_Support" id="Amount_Of_Support" class="form-control" placeholder="Enter Name of Publisher" required>
                        </div>
                    </div>
...
<?php 
    if (isset($_POST["submit"])) 
    {
        ...
        $sth = "SELECT * FROM `financial_support` WHERE user_id=$id AND (Academic_Year LIKE '%$str%' OR Name_Of_The_Teacher LIKE '%$str%' OR Branch LIKE '%$str%' OR Title_Of_Program LIKE '%$str%' OR Activity_Name LIKE '%$str%' OR Other_Activity LIKE '%$str%'  OR Dates_From LIKE '%$str%' OR Dates_To LIKE '%$str%' OR Name_Of_Activity LIKE '%$str%'  OR Amount_Of_Support LIKE '%$str%'   OR STATUS LIKE '$str')";
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#Activity_Name').val(data[5]);
                $('#Other_Activity').val(data[6]);
                $('#Dates_From').val(data[7]);
                $('#Dates_To').val(data[8]);
                $('#Name_Of_Activity').val(data[9]);
                $('#Amount_Of_Support').val(data[10]);
