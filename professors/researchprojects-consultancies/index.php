                ...
                <form action="insertcode.php" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="Duration_Of_The_Project" class="form-control" placeholder="Duration of project" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Funding_Agency_Website_Link" class="form-control" placeholder="Enter Link">
                        </div>
...
<div id="srch" class="card-body">
                <h4> Search Data </h4>
                    ...
                    <thead>
                        ...
                        <th> NATURE </th>
                        <th> NAME OF THE PROJECT/ENDOWNMENTS,CHAIRS </th>
