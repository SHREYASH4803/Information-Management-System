...
if(isset($_POST['insertdata']))
{
    ...
    (`Academic_year`,`Type_Research_Project_Consultancy`,`Branch`,`Name_Of_Project_Endownment`, `Name_Of_Principal_Investigator_CoInvestigator`, `Department_Of_Principal_Investigator`, `Year_Of_Award`,
     `Amount_Sanctioned`, `Duration_Of_The_Project`, `Name_Of_The_Funding_Agency`, `Funding_Agency_Website_Link`, 
     `Type_Govt_NonGovt`, `pdffile1`, `user_id`, `STATUS`) 
    VALUES ('$Academic_year','$Type_Research_Project_Consultancy', '$branch','$Name_Of_Project_Endownment', '$Name_Of_Principal_Investigator_CoInvestigator', '$Department_Of_Principal_Investigator', '$Year_Of_Award', 
