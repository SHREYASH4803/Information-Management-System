...
<head>
    ...
    <title> Faculty Achievement </title>
                ...
                <form action="insertcode.php" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Name_Of_The_Faculty" class="form-control" placeholder="Name_Of_The_Faculty" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="Nature_of_Achievement" class="form-control" required>
                                <option value="">Select Achievement</option>
                                <option name="Nature_of_Achievement" value="PhD Degree Awarded">PhD Degree Awarded</option>
                                <option name="Nature_of_Achievement" value="Best Paper Award">Best Paper Award</option>
                                <option name="Nature_of_Achievement" value="Best Project Award">Best Project Award</option>
                                <option name="Nature_of_Achievement" value="Best Thesis Award">Best Thesis Award</option>
                                <option name="Nature_of_Achievement" value="Patent">Patent</option>
                                <option name="Nature_of_Achievement" value="Other">Other</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label> Other </label>
                            <input type="text" name="other" class="form-control" placeholder="Enter if not specified ">
                        </div>

                        <div class="form-group">
                            <label> Details of Achievement* </label>
                            <input type="text" name="Details_of_Achievement" class="form-control" placeholder="Details_of_Achievement " required>
                        </div>
            ...
            <div id="tabledataid" class="card">
                <div class="card-body">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        ...
                        $table_query = "SELECT * FROM facultyachievement WHERE user_id= '$id' ";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel"> (Please enter the date again)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `facultyachievement` WHERE user_id=$id AND (Academic_Year LIKE '%$str%' OR Name_Of_The_Faculty LIKE '%$str%' OR Nature_of_Achievement LIKE '%$str%' OR Details_of_Achievement	 LIKE '%$str%' OR Branch LIKE '%$str%' OR other LIKE '%$str%' )";
