...
$queryresult = mysqli_num_rows($query); 
    ...
    {   
        ...
        move_uploaded_file($file_tmp1,"../../professors/fdp-sttp-attended/uploadsfdpattended1/$pdffile1");
    move_uploaded_file($file_tmp2,"../../professors/fdp-sttp-attended/uploadsfdpattended2/$pdffile2");
        
        $query = "UPDATE fdpsttpattended SET 
            Academic_year = '$Academic_year',
            Name_Of_The_Teacher = '$Name_Of_The_Teacher', 
            Branch = '$Branch', 
            Title_Of_Program = '$Title_Of_Program', 
            Professional_Body_Or_Organization_Associated = '$Professional_Body_Or_Organization_Associated', 
            Course_Type = '$Course_Type', 
            Organizing_Institute_And_Location = '$Organizing_Institute_And_Location', 
            Dates_From = '$Dates_From', 
            Dates_To = '$Dates_To', 
            Duration = '$Duration', 
            TA_Received = '$TA_Received', 
