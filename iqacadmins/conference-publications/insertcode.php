...
if(isset($_POST['insertdata']))
{
    ...
    move_uploaded_file($file_tmp1,"../../professors/conference-publications/Paper_Details/$pdffile1");
	move_uploaded_file($file_tmp2,"../../professors/conference-publications/Conference_Paper/$pdffile2");
    move_uploaded_file($file_tmp3,"../../professors/conference-publications/Conference_Certificate/$pdffile3");
    move_uploaded_file($file_tmp4,"../../professors/conference-publications/Application_Letter/$pdffile4");
